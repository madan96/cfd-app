...
public class MainPageMadan extends AppCompatActivity {
    int SELECT_PHOTO = 12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_page_madan);
        ...
        dialog_spinner= new ProgressDialog(MainPageMadan.this);
...
//                        agriNews.setVisibility(View.VISIBLE);
        ...
        agriMart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent fIntent = new Intent(MainPageMadan.this, ActivityPricesTabbed.class);
...
//        });
        ...
        cropcheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haveNetworkConnection() == true) {
                    ...
                    Toast.makeText(MainPageMadan.this, getString(R.string.mainpage_internet_offline_crop), Toast.LENGTH_SHORT).show();
                }
        ...
        diseaseCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haveNetworkConnection() == true) {
                    ...
                    Toast.makeText(MainPageMadan.this, getString(R.string.mainpage_internet_offline_disease), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        helpline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent fIntent = new Intent(MainPageMadan.this, ActiveHelpline.class);
                startActivity(fIntent);
            }
        });
    }
...
//        startActivityForResult(photoPickerIntent, SELECT_PHOTO);
        ...
        new AlertDialog.Builder(MainPageMadan.this).setTitle("Select Picture")
        ...
        AsyncHttpResponseHandler responseHandler = new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    if (response.getInt("status")==1) {
                        ...
                        Log.d("MainPageMadan", response.toString());
                    }
                    else if (response.getInt("status")==0){
                        dialog_spinner.dismiss();
                        Toast.makeText(MainPageMadan.this, "Unknown error occured. Please try again !" , Toast.LENGTH_SHORT).show();
                    }
                    else if (response.getInt("status")==2)  //image does not have leaf
                    {
                        dialog_spinner.dismiss();
                        Toast.makeText(MainPageMadan.this, "Error! No leaf found in the given image." , Toast.LENGTH_LONG).show();
            ...
            public void onRetry(int retryNo) {
                ...
                if (dialog_spinner.isShowing()) {
                    Toast.makeText(MainPageMadan.this, "Upload failed due to connection error. Trying again!", Toast.LENGTH_SHORT).show();
                }
                else {
                ...
                if (retryNo == 2) {
                    ...
                    Toast.makeText(MainPageMadan.this, "Upload failed. Please try again later!" , Toast.LENGTH_SHORT).show();
                    client_reponse.cancel(true);
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                dialog_spinner.dismiss();
                Log.d("upload","fail");
                Toast.makeText(MainPageMadan.this, "Upload failed. Please try again !" , Toast.LENGTH_SHORT).show();
            }
        };
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            Uri tempUri = getImageUri(MainPageMadan.this.getApplicationContext(), photo);
    ...
    public String getRealPathFromURIForGallery(Uri uri) {
        ...
        Cursor cursor = MainPageMadan.this.getContentResolver().query(uri, projection, null, null, null);
        if (cursor != null) {
    ...
    public String getRealPathFromURI(Uri uri) {
        Cursor cursor = MainPageMadan.this.getContentResolver().query(uri, null, null, null, null);
        cursor.moveToFirst();
    ...
    public void decodeFile(String path){
        ...
        {
            try {
                Log.d("MainPageMadan","Sending file ");
                sendFile(f);
        ...
        {
            Toast.makeText(MainPageMadan.this, "File error", Toast.LENGTH_SHORT).show();
        }
    }
}
